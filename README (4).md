...
2. Attach the [Serengeti2 dataset](https://www.kaggle.com/datasets/sylwiamielnicka/serengeti2)
3. Enable GPU accelerator (T4)
4. Run all cells in order

No local setup required — everything runs in the Kaggle cloud environment.
